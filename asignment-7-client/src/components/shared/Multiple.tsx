...
// The grid of icons with spider net connecting line system
const IconGrid = () => {
  const [hoveredId, setHoveredId] = useState<number | null>(null);

//   const outerIcons = [
//     { id: 1, component: <AiFillAmazonSquare /> },
//     { id: 2, component: <AiFillAmazonSquare /> },
//     { id: 3, component: <AiFillAmazonSquare /> },
//     { id: 4, component: <AiFillAmazonSquare /> },
//     { id: 5, component: <AiFillAmazonSquare /> },
//     { id: 6, component: <AiFillAmazonSquare /> },
//     { id: 7, component: <AiFillAmazonSquare /> },
//   ];

  // Constants for layout calculation
  
  const outerIcons = [
  { id: 1, component: <img src="/docker.jpg" alt="docker" className="w-12 h-12" /> },
  { id: 2, component: <img src="/postgres.png" alt="postgres" className="w-12 h-12" /> },
  { id: 3, component: <img src="/node-js.webp" alt="Node.js" className="w-12 h-12" /> },
  { id: 4, component: <img src="/mongoose.png" alt="MongoDB" className="w-12 h-12" /> },
  { id: 5, component: <img src="/tsc.png" alt="TypeScript" className="w-12 h-12" /> },
  { id: 6, component: <img src="/next.png" alt="nextJs" className="w-12 h-12" /> },
  { id: 7, component: <img src="/js.png" alt="js" className="w-12 h-12" /> },
  { id: 8, component: <img src="/prisma.png" alt="prisma" className="w-12 h-12" /> },
  { id: 9, component: <img src="/graphql.png" alt="graphql" className="w-12 h-12" /> },
  { id: 8, component: <img src="/aws.png" alt="aws" className="w-12 h-12" /> },
];
  ...
  return (
    <div className="relative w-[400px] h-[400px] scale-75 md:scale-90 lg:scale-100">
      ...
      <svg width={svgSize} height={svgSize} className="absolute top-0 left-0">
        ...
        <g>
          {/* Draw lines between outer icons */}
          ...
          {/* Draw lines from center to outer icons */}
          {outerIcons.map((icon, i) => {
