...
export default function ShimmerButton() {
  ...
  return (
    <div className="flex items-center justify-center font-sans">
      <style>{customCss}</style>
      <button className="relative inline-flex items-center justify-center p-[1.5px] rounded-full overflow-hidden group">
        <div
          className="absolute inset-0"
          style={{
            background: `
              conic-gradient(
                ...
                #a855f7,   /* purple */
                #ec4899,   /* pink */
                #3b82f6    /* back to blue for smooth loop */
              )
            `,
            animation: 'shimmer-spin 3s linear infinite',
          }}
        />
        <span className="relative z-10 inline-flex items-center justify-center w-full h-full px-8 py-3 
